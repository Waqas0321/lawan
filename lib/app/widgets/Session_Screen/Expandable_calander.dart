...
class ExpandableCustomCalender extends StatefulWidget {
  const ExpandableCustomCalender({super.key,
  ...
  @override
  State<ExpandableCustomCalender> createState() => _ExpandableCustomCalenderState();
}
        ...
        children: [
          ...
          TableCalendar(
            ...
            calendarStyle: CalendarStyle(
              ...
              weekendDecoration: widget.isSecondDessign? BoxDecoration(
                  color: AppColors.white,
                  borderRadius: BorderRadius.circular(16)
              ): BoxDecoration(

              ),
              todayDecoration:widget.isSecondDessign? BoxDecoration(
                  color: AppColors.white,
                  borderRadius: BorderRadius.circular(16)
              ):BoxDecoration(),
